...
public class DaoVendasProdutos extends Conexao {
    ...
    public boolean inserir(ArrayList<ModelVendaProduto> pListaModelVendaProduto) {
        String sql = "insert into tbl_vendas_produtos (fk_produto, fk_vendas, ven_pro_valor, ven_pro_quantidade) values (?, ?, ?, ?)";
        ...
        try {
            ...
            for (int i = 0; i < cont; i++) {
                ...
                stmt.setInt(1, pListaModelVendaProduto.get(i).getProduto());
                stmt.setInt(2, pListaModelVendaProduto.get(i).getVenda());
                stmt.setDouble(3, pListaModelVendaProduto.get(i).getVenProValor());
                stmt.setInt(4, pListaModelVendaProduto.get(i).getVenProQuantidade());
                stmt.execute();
